...
// 虚线模拟数据流相关
// 支持指定一个参考点 outwardFrom，使弧线朝远离该点的方向弯曲
function makeCurve(
  p1: [number, number],
  p2: [number, number],
  k = 0.22,
  ...
  const option: echarts.EChartsOption = {
    ...
    series: [
      ...
      // 5) 波纹动画点：显示各区名称，标在该区中心点（每区一个 effectScatter）
      {
        ...
        label: { show: true, formatter: '海淀区', position: 'top', fontSize: 18, fontWeight: 600 },
      ...
      },
      {
        ...
        showEffectOn: 'render',
        rippleEffect: { scale: 4, brushType: 'stroke' },
        label: { show: true, formatter: '昌平区', position: 'top', fontSize: 18, fontWeight: 600 },
        itemStyle: { color: '#32cd32', shadowBlur: 10, shadowColor: '#333' },
      ...
      },
      {
        ...
        showEffectOn: 'render',
        rippleEffect: { scale: 4, brushType: 'stroke' },
        label: { show: true, formatter: '余杭区', position: 'top', fontSize: 18, fontWeight: 600 },
        itemStyle: { color: '#32cd32', shadowBlur: 10, shadowColor: '#333' },
      ...
      // 6) 内置 symbol 定位点：三个校区（分别绑定到对应区的 geo）
      {
        ...
        symbol: 'pin',
        symbolSize: 26,
        label: { show: true, formatter: '北航沙河校区', position: 'top', fontSize: 18 },
      ...
      },
      {
        ...
        symbol: 'pin',
        symbolSize: 26,
        label: { show: true, formatter: '北航学院路校区', position: 'top', fontSize: 18 },
      ...
      },
      {
        ...
        symbol: 'pin',
        symbolSize: 26,
        label: { show: true, formatter: '北航杭州校区', position: 'top', fontSize: 18 },
